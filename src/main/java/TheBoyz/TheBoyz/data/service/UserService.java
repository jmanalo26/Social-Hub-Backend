...
public class UserService {
    ...
    public User saveUser(User user) {
        ...
        String searchedUsername  = userRepository.findUserNameByUsername(user.getUsername());
        String searchedPhoneNumber = userRepository.findUserPhoneNumberByPhoneNumber(user.getPhoneNumber()) ;
        String searchedEmail = userRepository.findUserEmailByEmail(user.getEmail());
        ...
        if(searchedUsername == null && searchedEmail == null && searchedPhoneNumber == null) {
            ...
            if (searchedUsername != null) {
                ...
                System.out.println("Found the user: " + searchedUser.getUsername());
                searchedUser.setUsername(null);
            }
            if (searchedEmail != null) {
                System.out.println("the email already exists, not saving to the db");
                System.out.println("Found the email: " + searchedUser.getEmail());
                searchedUser.setEmail(null);
            }
            if (searchedPhoneNumber != null) {
                System.out.println("the phone number already exists, not saving to the db");
                System.out.println("Found the user: " + searchedUser.getPhoneNumber());
                searchedUser.setPhoneNumber(null);
            }
        }
        return searchedUser;
